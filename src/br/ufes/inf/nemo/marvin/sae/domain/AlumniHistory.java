...
public class AlumniHistory extends PersistentObjectSupport implements Comparable<AlumniHistory>{
	...
	public enum PracticeArea
	{
		...
		{	
			switch(name){
				case "Entrepreneur": {return PracticeArea.ENTREPRENEUR;}
				case "Public Employee": {return PracticeArea.PUBLIC_EMPLOYEE;}
				case "Private Employee": {return PracticeArea.PRIVATE_EMPLOYEE;}
				case "Professor": {return PracticeArea.PROFESSOR;}
				default: {return PracticeArea.RESEARCHER;}
			}
		}
	}
	public enum DegreeArea
	{
		DEGREE_AREA("Works in degree area"),
		RELATED_AREA("Works in a releted area"),
		NON_RELATED_AREA("Works in a non-related area");
		...
		{	
			switch(name){
				case "Works in degree area": {return DegreeArea.DEGREE_AREA;}
				case "Works in a releted area": {return DegreeArea.RELATED_AREA;}
				default: {return DegreeArea.NON_RELATED_AREA;}
			}
		}
	}
	public enum SalaryRange
	{
		...
		{	
			switch(name){
				case "Until 3 minimum salaries": {return SalaryRange.UNTIL_3_SM;}
				case "From 3 to 5 minumum salaries": {return SalaryRange.FROM_3_TO_5_SM;}
				case "From 5 to 10 minumum salaries": {return SalaryRange.FROM_5_TO_10_SM;}
