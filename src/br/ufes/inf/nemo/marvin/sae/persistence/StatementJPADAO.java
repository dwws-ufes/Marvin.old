...
/**
 * Stateless session bean implementing a DAO for objects of the Statement domain class using JPA2.
 * 
 ...
 */
@Stateless
public class StatementJPADAO extends BaseJPADAO<Statement> implements StatementDAO {
	/** Serialization id. */
